<template>
    <div>
      ...
      <div class="bmain">
        <input type="text" style="border-bottom: 0.01rem solid #999;" placeholder="用户名" v-model="username"/>
        <div class="bhu">
      ...
      <div style="font-size: 0.8rem; color: red; margin-top: 1rem">
